        ...
        <div class="row is-grid flex-center">
            ...
            <div class="cell-6 text-left cell-6-lg cell-12-sm ">
                <div class="product-info pallette_1 no_bg">
                    <form class="without-old-price without-sku is-available" action="{{ route('cart.add') }}" method="post"
                        data-product-id="153305456" data-recently-view="153305456"
                        data-product-gallery=".js-product-gallery-main">
                        @csrf
                        <h1 class="product-title h2-like m-t-0 m-b-10">
                            {{ $product->name }}
                            <sup class="product-sku" data-product-sku="" style="display: none;"></sup>
                        </h1>
                        ...
                        <div class="product-prices m-b-30">
                            <div class="inline-middle h2-like">
                                <span data-product-price="" class="c_special_2_color">{{ $product->price_format }}</span>
                            </div>
                            &nbsp;
                            <div class="inline-middle h2-like">
                                <span data-product-old-price="" style="display: none;"></span>
                            </div>
                        </div>
                        <div class="product-buy row flex-middle is-grid m-b-50 is-active">
